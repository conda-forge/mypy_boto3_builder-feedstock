...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mypy_boto3_builder-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12750&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mypy_boto3_builder-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mypy_boto3_builder` can be installed with:

```
conda install mypy_boto3_builder
```

It is possible to list all of the versions of `mypy_boto3_builder` available on your platform with:
